...
sampleRate = 50 # (rate = 100 times per second, based on HAL_DELAY in STM32 loop, which is set to 10 ms (1000 ms / 20 ms = 50)) # TODO: add variable to pull HAL_DELAY value and thus sample rate from stm32 firmware instead of manually changing it every time
